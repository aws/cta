...
namespace CTA.Rules.Test.Actions
{
    public class ClassActionsTests
    {
        ...
        public void SetUp()
        {
            ...
            var file = Path.Combine(_projectDir, "MonolithService.cs");
            File.WriteAllText(file, GetMonolithServiceTemplate());
...
public ActionResult SuperStringMethod()
{
    return Content(MonolithService.CreateRequest().Result);
        ...
        public void CreateMonolithService()
        {
            ...
            var CreateMonolithServiceFunc = _classActions.GetCreateMonolithServiceAction(namespaceString);
        ...
        private string GetMonolithServiceTemplate()
        {
            return @"
using System;
