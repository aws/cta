...
{
    [TestFixture]
    public class AnyConditionTemplateConditionTests
    {
        private AnyConditionTemplateCondition _condition;
        ...
        public void OneTimeSetup()
        {
            ...
            _condition = new AnyConditionTemplateCondition()
            {
        ...
        [Test]
        public void ConditionIsMet_Returns_True_When_Some_Sub_Conditions_Are_Met()
        {
            var grandparent = HtmlNode.CreateNode("<div></div>");
        ...
        [Test]
        public void ConditionIsMet_Returns_True_When_One_Sub_Condition_Is_Met()
        {
        ...
        [Test]
        public void ConditionIsMet_Returns_False_When_No_Sub_Conditions_Are_Met()
        {
            var grandparent = HtmlNode.CreateNode("<span></span>");
            var parent = HtmlNode.CreateNode("<div></div>");
        ...
        {
            var condition = new AnyConditionTemplateCondition()
            {
